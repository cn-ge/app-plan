...
export class ExportComponent implements OnInit, OnDestroy {
  ...
  getMondayBefore(cours: CoursPlanning) {
    if (this.planning.planning_courses.indexOf(cours) != 0) {var beforeDate = new Date(this.planning.planning_courses[this.planning.planning_courses.indexOf(cours)-1].date_end);
      beforeDate.setDate(beforeDate.getDate() + 3);
